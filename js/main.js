...
const testData = async(cityName, stateCode, countryCode) => {
    ...
    const getTestData = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName},${stateCode}, ${countryCode}&units=imperial&appid=39fc93c2a4e618396ba3aa95200af967`);
